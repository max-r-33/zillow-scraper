...
def getUrls(pagesToScrape):
  ...
  while(currPage <= pagesToScrape):
    baseUrl = 'https://www.zillow.com/homes/for_sale/Santa-Cruz-CA/pmf,pf_pt/13715_rid/globalrelevanceex_sort/37.187672,-121.807824,36.902136,-122.342034_rect/10_zm/' + str(currPage) + '_p/'
    urls.append(baseUrl)
    currPage = currPage + 1
  return urls;
